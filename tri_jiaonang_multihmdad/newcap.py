...
def CapsNet(input_shape, n_class, routings):
    ...
    conv1 = layers.convolutional.Convolution2D(filters=32, kernel_size=(2,39), strides=1, padding='valid',
                                               activation='relu', name='conv1')(x)
    primarycaps = PrimaryCap(conv1, dim_capsule=8, n_channels=32, kernel_size=(31,1), strides=1, padding='valid')
